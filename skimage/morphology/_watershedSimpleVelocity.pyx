    ...
    while hp.items > 0:
        ...
        if velocityLabels[elem.index]>0:
            ...
            for i in range(nneighbors):
                ...
                #Add if it belongs to the same label class
                if velocityLabels[index] == velocityLabel:
                ...
                elif velocityLabels[index] == 0:
                    #If not it has to be a regular DEM point
                    age += 1
                    new_elem.value = image[index]
                    if compactness > 0:
                        new_elem.value += (compactness *
