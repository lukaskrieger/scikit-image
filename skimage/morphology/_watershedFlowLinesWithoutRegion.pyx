...
def watershed_raveled(cnp.float64_t[::1] image,
    ...
    while hp.items > 0:
        ...
        #print("Index", elem.index, "output", output[elem.index])
        ...
        if output[elem.index] and elem.index != elem.source:
            ...
            #print("Index", elem.index, "already set to", output[elem.index])
            continue
        ...
        if velocityLabels[elem.index]>0:
            ...
            output[elem.index] = outputAtSource
            ...
            for connectedIndex in connectedIndices[velocityLabel-1]:
                ...
                #Now put entire neighborhood in queue
                for i in range(nneighbors):
                    # get the flattened address of the neighbor
                    index = structure[i] + connectedIndex
