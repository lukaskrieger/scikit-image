...
from . import _watershedFlowLinesWithoutRegion
...
def watershedFlowLinesWithoutRegion(image, markers, connectivity=1, offset=None, mask=None, velocityLabels=None, connectedIndices=None, compactness=0, watershed_line=False):
    ...
    _watershedFlowLinesWithoutRegion.watershed_raveled(image.ravel(),
                                 marker_locations, flat_neighborhood,
                                 mask, velocityLabels.ravel(), connectedIndices, image_strides, compactness,
                                 output.ravel(),
                                 watershed_line)
