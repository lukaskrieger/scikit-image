...
from . import _watershedSimpleVelocity
...
def watershedSimpleVelocity(image, markers, connectivity=1, offset=None, mask=None, velocityLabels=None, compactness=0, watershed_line=False):
    ...
    _watershedSimpleVelocity.watershed_raveled(image.ravel(),
                                 marker_locations, flat_neighborhood,
                                 mask, velocityLabels, image_strides, compactness,
                                 output.ravel(),
                                 watershed_line)
